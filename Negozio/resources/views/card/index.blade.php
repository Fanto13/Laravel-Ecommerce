...
<form action="Riepilogo.php" method="post">
    <table align="center" cellpadding="2" cellspacing="2" border="2" bgcolor="white" width="40%">
            <tbody><tr> 
                ...
                <td>N°della carta</td>
                <td><input type="text" name="numcarta" maxlength="16"></td>
            </tr>
            <tr>
                <td>Codice carta</td>
                <td><input type="int" name="codicecarta" placeholder="5 cifre" maxlength="5" size="10">&nbsp;CVV<input type="int" name="cvv" placeholder="3 cifre" maxlength="3" size="5"></td>
            ...
            <tr>
                <td colspan="2">
                  <a href="{{ URL::action('CardController@store')}}"><button type="button" <button type="button"
                    class="btn btn-primary float-right">Piazza l'ordine</button></a><input type="reset" value="Clear"></center></td>
            </tr>
        </tbody></table>
    </form>

                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row"> 
                             ...
                             <div class="col-md-6">
                                ...
                                <input id="sex" type="radio" class="form-control @error('sex') is-invalid @enderror"
                                    name="sex" value="{{ old('sex') }}" required autocomplete="sex" autofocus> 
                                    
                                    <label class="radio"> <input type="radio" name="m">Femmina</label>
                                    <label class="radio"> <input type="radio" name="f">Maschio</label></div>
                                @error('sex')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                @enderror
                                 ...
                                 {{-- <div class="form-group row">
                                <label id ="sex" for="sex" class="col-md-4 col-form-label text-md-right">{{ __('Sesso') }}</label>
                                <input type="radio" name="m" value="m"/> Maschio
                                
                                <input type="radio" name="f" value="f"/> Femmina
